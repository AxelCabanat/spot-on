...
-- AlterTable
ALTER TABLE `studio` ADD COLUMN `description4` TEXT NULL,
    ADD COLUMN `description5` TEXT NULL,
    ADD COLUMN `title4` TEXT NULL,
    ADD COLUMN `title5` TEXT NULL,
    ADD COLUMN `url4` TEXT NULL,
    ADD COLUMN `url5` TEXT NULL,
